    ...
    <div class="container">
        <div class="manifeste-content">
            <a href="{{ asset('documents/LE MANIFESTE MBRC.pdf') }}"
                ...
                download="MBRC-Manifeste.pdf">Manifeste Fondateur
    ...
    <div class="container">
        ...
        <div class="valeurs-grid">
            ...
            <div class="valeur-card">
                ...
                <h3 class="valeur-title">Formation</h3>
                <p class="valeur-text">
...
<section class="section section-light">
    <div class="container">
        <div class="section-header">
            ...
            <h2 class="section-title">Les filles et fils du Bénin derrière <br> (Citoyens Béninois de tout horizon)</h2>
